...
class ModelConfigurationController {
  ...
  static async getModelConfiguration(req, res) {
    fs.readFile("config/model_configuration.json", "utf8", (err, data) => {
      if (err) {
  ...
  static async updateModelConfiguration(req, res) {
...
export default ModelConfigurationController;
